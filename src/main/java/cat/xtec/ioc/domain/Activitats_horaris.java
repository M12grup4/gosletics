...
public class Activitats_horaris {
    private int a_id;
    ...
    public Activitats_horaris(int a_id, String a_nombre, int a_activa, Date h_fecha, int h_hora, int h_tiempo_actividad, int h_plazas_ocupadas, int n_participantes_max) {
        this.a_id = a_id;
