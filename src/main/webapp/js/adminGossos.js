...
function createDogItem(gossos) {
    gossos.forEach((element) => {
        let gos = $('<tr class="output" id="' + element.id + '">        <td>' + element.id + '</td>        <td>' + element.nombre + '</td>        <td>' + element.raza + '</td>        <td>' + element.id_cliente + '</td>        <td class="action" id="updateButton">Modifica</td>        <td class="action" id="bajaButton">Baja</td>    </tr>');
